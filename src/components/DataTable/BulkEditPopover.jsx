// popover that lets the user pick one column + one value and apply it to all selected rows.
// appears in the toolbar whenever at least one row is selected.
// it closes when the user clicks outside it or after they hit "Apply".
...
export function BulkEditPopover({ columns, selectedCount, onApply }) {
  ...
  // only non-readOnly, non-selection columns can be bulk-edited.
    ...
    <div className="bulkEditPopover" ref={containerRef}>
      ...
      {isOpen && (
        <div className="bulkEditPanel">
          ...
          {/* step 2: enter the value for that column */}
          {column && (
